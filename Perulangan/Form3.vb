Public Class Form3
    ...
    Private Sub copyToArray(ByVal baris1 As Integer, baris2 As Integer, kolom1 As Integer, kolom2 As Integer, ByRef nilai(,) As Integer, ByRef nilai2(,) As Integer)
        If (Me.cekKolom) Then
            For baris As Integer = 0 To baris1 - 1
                For kolom As Integer = 0 To kolom1 - 1
                    nilai(baris, kolom) = TextBox1.Lines.ElementAt(baris).Split(" ").ElementAt(kolom)
            ...
            Select Case ComboBox1.Text
                Case "Tambah"
                    For baris As Integer = 0 To batasBaris - 1
                        For kolom As Integer = 0 To batasBaris - 1
